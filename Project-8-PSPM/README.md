...
This challenge involves working with a dataset, where not all features are necessary. You will also have to encode your categorical labels, and run test predictions on your model.
...
### The Dataset:
Kaggle Dataset: 
[Plant-Health-Data](https://www.kaggle.com/datasets/ziya07/plant-health-data)
...
- Link to implementation: [Notebook](project-8-pspm.ipynb)
