# Contributing to OPEN-ARC

Thank you for considering contributing to **OPEN-ARC**! Contributions, whether they are bug fixes, new features, or improvements to the documentation, are always welcome. Before contributing, please read the following guidelines to ensure smooth collaboration.
...
1. **Report Issues**  
   Use the [GitHub Issues page](https://github.com/Infinitode/OPEN-ARC/issues) to report bugs or suggest features. Please include:
...
3. **Follow Licensing Requirements**  
   Ensure that any derivative works comply with the [license](https://github.com/infinitode/OPEN-ARC/blob/main/LICENSE.md).

By contributing, you agree to abide by these guidelines and this project's [license](https://github.com/infinitode/OPEN-ARC/blob/main/LICENSE.md). Thank you for helping make **OPEN-ARC** better!